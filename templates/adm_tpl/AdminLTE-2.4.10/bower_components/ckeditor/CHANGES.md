...
* [#2403](https://github.com/ckeditor/ckeditor-dev/issues/2403): Fixed: Styling inline editor initialized inside a table with the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin is causing style leaks.
* [#2514](https://github.com/ckeditor/ckeditor-dev/issues/2403): Fixed: Pasting table data into inline editor initialized inside a table with the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin inserts pasted content into the wrapping table.
...
* [#2650](https://github.com/ckeditor/ckeditor-dev/issues/2650): Fixed: [Outgoing](https://ckeditor.com/cke4/addon/table) dialog validator fails when the `getValue()`function is defined in the global scope.
...
* [#706](https://github.com/ckeditor/ckeditor-dev/issues/706): Added a different cursor style when selecting cells for the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin.
...
* [#1489](https://github.com/ckeditor/ckeditor-dev/issues/1489): Fixed: Outgoing contents can be removed in read-only mode when the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin is used.
* [#1264](https://github.com/ckeditor/ckeditor-dev/issues/1264) Fixed: Right-click does not clear the selection created with the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin.
...
* [#1816](https://github.com/ckeditor/ckeditor-dev/issues/1816): Fixed: Outgoing breaks when <kbd>Enter</kbd> is pressed over the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin.
...
* [#1467](https://github.com/ckeditor/ckeditor-dev/issues/1467): Fixed: The resizing cursor of the [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) plugin appearing in the middle of a merged cell.
...
* [#522](https://github.com/ckeditor/ckeditor-dev/issues/522): Fixed: Widget selection is not removed when widget is inside table cell with [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin enabled.
* [#1027](https://github.com/ckeditor/ckeditor-dev/issues/1027): Fixed: Cannot add multiple images to the table with [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin in certain situations.
...
* [#577](https://github.com/ckeditor/ckeditor-dev/issues/577): Fixed: The "Delete Columns" command provided by the [Outgoing Tools](https://ckeditor.com/cke4/addon/tabletools) plugin throws an error when trying to delete columns.
...
* [#694](https://github.com/ckeditor/ckeditor-dev/pull/694): Refactoring in the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin:
...
* [#579](https://github.com/ckeditor/ckeditor-dev/issues/579): Fixed: Internal `cke_table-faked-selection-table` class is visible in the Stylesheet Classes field of the [Outgoing Properties](https://ckeditor.com/cke4/addon/table) dialog.
...
* [#582](https://github.com/ckeditor/ckeditor-dev/issues/582): Fixed: Double slash in the path to stylesheet needed by the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin. Thanks to [Marius Dumitru Florea](https://github.com/mflorea)!
...
* [#515](https://github.com/ckeditor/ckeditor-dev/issues/515): [Chrome] Fixed: Mouse actions on CKEditor scrollbar throw an exception when the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin is loaded.
...
* [#417](https://github.com/ckeditor/ckeditor-dev/issues/417): Fixed: The [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) plugin throws an error when used with a table with only header or footer rows.
...
* [#16755](https://dev.ckeditor.com/ticket/16755): Added the [Outgoing Selection](https://ckeditor.com/cke4/addon/tableselection) plugin that lets you select and manipulate an arbitrary rectangular table fragment (a few cells, a row or a column).
...
* [#16971](https://dev.ckeditor.com/ticket/16971): Added support for color in the `background` property containing also other styles for table cells in the [Outgoing Tools](https://ckeditor.com/cke4/addon/tabletools) plugin.
...
* [#16811](https://dev.ckeditor.com/ticket/16811): Fixed: Outgoing alignment is not preserved by the [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
...
* [#10472](https://dev.ckeditor.com/ticket/10472): Fixed: Unable to use [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) on table header and footer.
* [#14762](https://dev.ckeditor.com/ticket/14762): Fixed: Hovering over an empty table (without rows or cells) throws an error when the [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) plugin is active.
...
* [#13388](https://dev.ckeditor.com/ticket/13388): Fixed: [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) integration with [Undo](https://ckeditor.com/cke4/addon/undo) is broken.
...
* [#8024](https://dev.ckeditor.com/ticket/8024): Swapped behavior of the Split Cell Vertically and Horizontally features of the [Outgoing Tools](https://ckeditor.com/cke4/addon/tabletools) plugin to be more intuitive. Thanks to [kevinisagit](https://github.com/kevinisagit)!
...
* [#12825](https://dev.ckeditor.com/ticket/12825): Fixed: Preventing the [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) plugin from operating on elements outside the editor. Thanks to [Paul Martin](https://github.com/Paul-Martin)!
...
* [#12164](https://dev.ckeditor.com/ticket/12164): Added the "Justify" option to the "Horizontal Alignment" drop-down in the Outgoing Cell Properties dialog window.
...
* [#11626](https://dev.ckeditor.com/ticket/11626): Fixed: [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) sets invalid column width.
...
* [#11823](https://dev.ckeditor.com/ticket/11823): [IE8] Fixed: [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) throws an error over scrollbar.
...
* [#11603](https://dev.ckeditor.com/ticket/11603): Fixed: [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) attaches to tables outside the editable.
...
* [#11660](https://dev.ckeditor.com/ticket/11660): [IE] Fixed: Outgoing content is lost when some extra markup is inside the table.
...
* [#11179](https://dev.ckeditor.com/ticket/11179): Fixed: [`editor.destroy()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-destroy) does not cleanup content generated by the [Outgoing Resize](https://ckeditor.com/cke4/addon/tableresize) plugin for inline editors.
* [#11237](https://dev.ckeditor.com/ticket/11237): Fixed: Outgoing border attribute value is deleted when pasting content from Microsoft Word.
...
* [#10389](https://dev.ckeditor.com/ticket/10389): Fixed: Invalid HTML in the "Text and Outgoing" template.
...
* [#9875](https://dev.ckeditor.com/ticket/9875): Outgoing dialog window does not populate width correctly.
...
* [#9553](https://dev.ckeditor.com/ticket/9553): Outgoing width incorrectly set when the `border-width` style is specified.
...
* [#9726](https://dev.ckeditor.com/ticket/9726): Removed [Color Dialog](https://ckeditor.com/cke4/addon/colordialog) plugin dependency from [Outgoing Tools](https://ckeditor.com/cke4/addon/tabletools).
